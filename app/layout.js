...
export const metadata = {
  title: 'Futbol 5 Pa',
  description: 'Unite y Jugá un Partido de Futbol 5',
}
      ...
      <body className={inter.className}><Providers>
        <div class="h-screen w-full  relative flex overflow-hidden">
          ...
          <aside class="h-full w-16 flex flex-col space-y-10 items-center justify-center relative bg-gray-800 text-white">
            ...
            >
              <div class="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear ">
          ...
          <div class="w-full h-full flex flex-col justify-between">
            ...
            <main class="max-w-full h-full flex relative overflow-y-hidden">
              ...
              <div class="h-full w-full xl:m-4 flex flex-wrap items-start justify-around  rounded-tl grid-flow-col auto-cols-max gap-4 ">
